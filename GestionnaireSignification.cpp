...
std::string GestionnaireSignification::recupererDonnees(std::string identifiant){
	...
	Sleep(100);
	char message[2000];
	int n=client.Recevoir(message,2000,0);
...
std::string GestionnaireSignification::recupererSignification(std::string identifiant,int numOctet){
